...
//                System.out.println("fsa"+cart.getCartItemList().get(i).getItem().getItemId());
//                System.out.println("why"+cartItems.get(i).getItem().getItemId());
            }
...
//            request.getRequestDispatcher(REMOVE_ITEM).forward(request,response);
    ...
    @PostMapping("/update")
    public String updateCart(String itemId, HttpSession session) {
