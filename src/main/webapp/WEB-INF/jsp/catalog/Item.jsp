...
<div id="BackLink">
	<a href="view_product?productId=${sessionScope.product.productId}">Return to ${sessionScope.product.productId}</a>
</div>
...
<table>
	...
	<tr>
		<td>
			<b>
				<font size="4"> ${sessionScope.item.attribute1}
	...
	<tr>
		<td>
			...
			<c:if test="${sessionScope.item.quantity > 0}">${sessionScope.item.quantity} in stock.
	  		</c:if>
		</td>
	</tr>
	<tr>
	...
	<tr>
		<td>
			<a class="Button" href="addToCart?workingItemId=${sessionScope.item.itemId}">Add to Cart</a>
		</td>
	</tr>
</table>
